 ...
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      #else
      virtual void GetVerifyCode(::grpc::ClientContext* context, const ::message::GetVerifyCodeReq* request, ::message::GetVerifyCodeRsp* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      #else
      void GetVerifyCode(::grpc::ClientContext* context, const ::message::GetVerifyCodeReq* request, ::message::GetVerifyCodeRsp* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
     private:
      friend class Stub;
  ...
  class ExperimentalWithCallbackMethod_GetVerifyCode : public BaseClass {
   ...
   public:
    ...
    #endif
                     context, const ::message::GetVerifyCodeReq* request, ::message::GetVerifyCodeRsp* response) { return this->GetVerifyCode(context, request, response); }));}
    void SetMessageAllocatorFor_GetVerifyCode(
        ::grpc::experimental::MessageAllocator< ::message::GetVerifyCodeReq, ::message::GetVerifyCodeRsp>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    virtual ::grpc::ServerUnaryReactor* GetVerifyCode(
      ::grpc::CallbackServerContext* /*context*/, const ::message::GetVerifyCodeReq* /*request*/, ::message::GetVerifyCodeRsp* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* GetVerifyCode(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::message::GetVerifyCodeReq* /*request*/, ::message::GetVerifyCodeRsp* /*response*/)
    #endif
      { return nullptr; }
  };
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
