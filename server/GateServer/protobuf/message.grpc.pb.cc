...
::grpc::Status VerifyService::Stub::GetVerifyCode(::grpc::ClientContext* context, const ::message::GetVerifyCodeReq& request, ::message::GetVerifyCodeRsp* response) {
...
void VerifyService::Stub::experimental_async::GetVerifyCode(::grpc::ClientContext* context, const ::message::GetVerifyCodeReq* request, ::message::GetVerifyCodeRsp* response, std::function<void(::grpc::Status)> f) {
...
void VerifyService::Stub::experimental_async::GetVerifyCode(::grpc::ClientContext* context, const ::message::GetVerifyCodeReq* request, ::message::GetVerifyCodeRsp* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::message::GetVerifyCodeRsp>* VerifyService::Stub::PrepareAsyncGetVerifyCodeRaw(::grpc::ClientContext* context, const ::message::GetVerifyCodeReq& request, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientAsyncResponseReader< ::message::GetVerifyCodeRsp>* VerifyService::Stub::AsyncGetVerifyCodeRaw(::grpc::ClientContext* context, const ::message::GetVerifyCodeReq& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
VerifyService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< VerifyService::Service, ::message::GetVerifyCodeReq, ::message::GetVerifyCodeRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](VerifyService::Service* service,
...
::grpc::Status VerifyService::Service::GetVerifyCode(::grpc::ServerContext* context, const ::message::GetVerifyCodeReq* request, ::message::GetVerifyCodeRsp* response) {
  (void) context;
  (void) request;
  (void) response;
